# Search — Cross-Marketplace Price Index

> Built for the **Agentic Engineering Hack**, May 23, 2026 — Datadog office, NYC. [Devpost](https://agentic-engineering-hack.devpost.com/).
...
- 3-min demo: _TBD_
- Repo: this one (root)
- Sponsor tools: Nimble + ClickHouse (payment rails optional via x402/MPP for cost tracking)
